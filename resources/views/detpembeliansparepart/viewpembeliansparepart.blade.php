...
[
'title'=>'Table Pembelian Sparepart',
...
<section class="content">
  ...
  @endif
        <div class="col-8">
            <h3 class="card-title">Data Pembelian Sparepart</h3> 
        </div>
        <div class="col-4 d-flex justify-content-end">
            <a class="btn btn-success" href="{{route('add-pembeliansparepart')}}">Tambah Data</a>
        </div>
    </div>
        ...
        <tbody>
            ...
            @foreach($dataPembelian as $data)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="edit-pembeliansparepart/{{$data->id_vendor}}">Edit</a>
                            <a class="btn btn-danger" href="del-pembeliansparepart-action/{{$data->id_vendor}}">Delete</a>
                        </form>
                    </td>
                    </tr>
            @endforeach
